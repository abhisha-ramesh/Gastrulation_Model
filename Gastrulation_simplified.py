...
Parameters varied in the paper:
    lambda_link_basal             (line 55)
    lambda_link_apical_peripheral (line 61)
    lambda_link_apical_central    (line 62)
    n_cells                       (line 84)
    starting_stiffness            (line 69)
"""
...
lambda_link_apical_central = 100                      #strength of central apical-core links(central sub-apical stiffness)
